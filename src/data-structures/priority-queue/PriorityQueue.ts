...
export default class PriorityQueue extends MinHeap {
   ...
   * @return {PriorityQueue}
   */
  remove(item: number, customFindingComparator: Comparator) {
   ...
   * @return {PriorityQueue}
   */
  changePriority(item: number, priority: number) {
